Module ModMain
    ...
    Public DEVICE_LABEL_ONLINE As LabeldeviceStatus
    Public DEVICE_LABEL_OFFLINE As LabeldeviceStatus
    ...
    Public Sub Initialization()
        ...
        DEVICE_LABEL_OFFLINE = New LabeldeviceStatus(deviceStatus.Online, Color.Black, Color.Red, " offline ")
        DEVICE_LABEL_ONLINE = New LabeldeviceStatus(deviceStatus.Online, Color.Black, Color.LimeGreen, " online ")
